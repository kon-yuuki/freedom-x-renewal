...
<nav class="c-breadNav">
  <ul class="c-breadNav-list">
    ...
    <li class="c-breadNav-item is-current">
      <span class="c-breadNav-link">お知らせ
      </span>
    </li>
  </ul>
</nav>
...
<section class="p-news-fv js-stalker-area">
  <div class="l-fv">
    <hgroup class="l-fv__heading">
      <h1 class="l-fv__heading--main">お知らせ</h1>
    </hgroup>
  </div>
  <?php 
          ...
          if($pickup_news):
        ?>
  <div class="p-news-fv__pickup c-grid-outer">
    <div class="p-top-news__pickup">
      <h2 class="p-top-news__pickup--ttl">Pickup</h2>
...
<div class="c-content rev c-grid-outer" data-gap="5">
  <main class="c-mainGrid">
    <div class="c-news-list">
      ...
      // "hidden"タクソノミーを除外するタクソノミークエリを追加
      $tax_query = array(
        array(
