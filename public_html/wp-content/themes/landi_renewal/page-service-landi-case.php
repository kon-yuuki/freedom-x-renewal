...
$pageinfo = array(
  'page_id' => 'landi-case',
  'navigation' => 'landi-case renewal service-detail',
...
<nav class="c-breadNav">
  <ul class="c-breadNav-list">
    ...
    <li class="c-breadNav-item">
      <a href="/service" class="c-breadNav-link c-linelink--hidden"><span class="c-linelink__txt">サービス紹介</span></a>
    </li>
    <li class="c-breadNav-item">
      <a href="/service/landi" class="c-breadNav-link c-linelink--hidden"><span
          class="c-linelink__txt">ランディPROトップ</span></a>
    </li>
    <li class="c-breadNav-item is-current">
      <span class="c-breadNav-link">ランディPROの機能と効果
      </span>
    </li>
  </ul>
</nav>
...
<div class="l-fv">
  <hgroup class="l-fv__heading">
    <h1 class="l-fv__heading--main">ランディPROの<br class="pc-hidden">機能と効果</h1>
  </hgroup>
  ...
  <main class="p-case">
    <div class="c-grid-inner">
        ...
        <ul class="c-anchor__list">
          <li class="c-anchor__item">
            <a href="#strength" class="c-linelink c-anchor__link">
              <span class="c-linelink__txt">土地探し機能</span>
          ...
          <li class="c-anchor__item">
            <a href="#solution" class="c-linelink c-anchor__link">
              <span class="c-linelink__txt">営業活動効率化</span>
              <span class="c-anchor__icon">
                <svg class="c-anchor__arw">
                  <use href="#i-arw-down"></use>
                </svg>
      ...
      <section class="c-section p-case__function">
        <h2 class="c-ttl__h2 c-sp-section-separate">5つの土地探し機能</h2>
            ...
            <ul class="p-case__function-list">
              <li class="p-case__function-item">
                <div class="p-case__function-content">
                  <p class="p-case__function-text"><strong>非公開物件も含めた全土地情報</strong>を集約し、営業と顧客の双方で土地探しツールの一元化が可能。
                  </p>
                </div>
      ...
      <section class="c-section p-case__id">
        <h2 class="c-ttl__h2 c-sp-section-separate">顧客専用アカウント「顧客ID」</h2>
        ...
        <picture class="p-case__id-hero  c-image border">
          <source srcset="<?php echo $img_path; ?>service/landi/id-sp.avif" type="image/avif" media="(max-width:102px)">
          <source srcset="<?php echo $img_path; ?>service/landi/id-sp.webp" type="image/webp"
        ...
        <p class="p-case__id-copy"><strong>顧客自身が自宅でも土地探しができる</strong>から<br class="sp-hidden">顧客流出を防ぎ、候補地確定スピード、成約率が上がる
        </p>
        <picture class="p-case__id-image">
          <source srcset="<?php echo $img_path; ?>service/landi/merit01-sp.avif" type="image/avif"
            media="(max-width:102px)">
          <source srcset="<?php echo $img_path; ?>service/landi/merit01-sp.webp" type="image/webp"
            media="(max-width:1023px)">
        ...
        <p class="p-case__id-copy"><strong>顧客の検索動向が可視化</strong>され、<br class="sp-hidden">最適な追客アプローチが可能になる</p>
        <p class="c-txt u-align-center u-align-center__sp-left">
          ランディPROの追客機能を利用して、お客様の土地探しの動向を確認しつつ、<br class="sp-hidden">適切なタイミングで電話やメールのアプローチができます。
        </p>
        <div class="c-col c-col--2 p-case__id-col">
          <div class="c-col__item">
      ...
      <section class="c-section p-case__simulation">
        <h2 class="c-ttl__h2 c-sp-section-separate">資金シュミレーション機能</h2>
        <p class="c-txt">
        ...
        <div class="c-col col3 p-case__simulation-col">
          <div class="c-col__item">
