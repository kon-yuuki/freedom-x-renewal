...
$pageinfo = array(
  'page_id' => 'landi',
  'navigation' => 'renewal service-landi service-detail',
...
<section class="p-service-detail__fv">
  ...
  <div class="p-service-detail__fv-inner">
    ...
    <p class="p-service-detail__fv-text sp-hidden">土地探し顧客への「資金計画合意」・「候補地確定」の課題をDXで効率化。<br>
  ...
  <p class="p-service-detail__fv-text pc-hidden">
...
<main class="p-service-detail">
  <section class="p-service-detail__section p-service-detail__trouble">
    <div class="p-service-detail__section-inner">
      <h2 class="p-service-detail__section-title center">
        ...
        <span class="p-service-detail__section-title-large">よくある<strong class="u-txt-red">3つのお悩み</strong></span>
      </h2>
    ...
    <picture class="p-service-detail__trouble-solution">
      <source srcset="<?php echo $img_path; ?>service/landi/trouble-solution_sp.avif" type="image/avif"
        media="(max-width:1023px)">
      <source srcset="<?php echo $img_path; ?>service/landi/trouble-solution_sp.webp" type="image/webp"
        media="(max-width:1023px)">
  ...
  <section class="p-service-detail__section p-service-detail__reason section-dot-separate">
    <div class="c-grid-inner">
      ...
      <picture class="p-service-detail__dialog">
        <source srcset="<?php echo $img_path; ?>service/landi/reason-dialog_sp.avif" type="image/avif"
          media="(max-width:1023px)">
        <source srcset="<?php echo $img_path; ?>service/landi/reason-dialog_sp.webp" type="image/webp"
          media="(max-width:1023px)">
  ...
  <section class="p-service-detail__section p-service-detail__reason02 section-clip">
    <div class="p-service-detail__reason02-top">
        ...
        <div class="p-service-detail__reason02-content">
          <div class="p-service-detail__reason02-graph">
            <picture class="p-service-detail__reason02-graph-image">
              <source srcset="<?php echo $img_path; ?>service/landi/reason02-graph_sp.avif" type="image/avif"
                media="(max-width:1023px)">
              <source srcset="<?php echo $img_path; ?>service/landi/reason02-graph_sp.webp" type="image/webp"
                media="(max-width:1023px)">
      ...
      <picture class="p-service-detail__reason02-dialog--1">
        <source srcset="<?php echo $img_path; ?>service/landi/reason02-dialog--1_sp.avif" type="image/avif"
          media="(max-width:1023px)">
        <source srcset="<?php echo $img_path; ?>service/landi/reason02-dialog--1_sp.webp" type="image/webp"
          media="(max-width:1023px)">
    ...
    <div class="p-service-detail__reason02-bottom c-grid-inner">
      ...
      <div class="p-service-detail__reason02-bottom-graph ">
        <picture class="p-service-detail__reason02-bottom-graph-image">
          <source srcset="<?php echo $img_path; ?>service/landi/reason02-bottom-graph_sp.avif" type="image/avif"
            media="(max-width:1023px)">
          <source srcset="<?php echo $img_path; ?>service/landi/reason02-bottom-graph_sp.webp" type="image/webp"
            media="(max-width:1023px)">
    ...
    <div class="p-service-detail__reason02-dialog">
      <div class="p-service-detail__reason02-dialog-inner">
        <picture class="p-service-detail__reason02-dialog-image">
          <source srcset="<?php echo $img_path; ?>service/landi/reason02-dialog2_sp.avif" type="image/avif"
            media="(max-width:1023px)">
          <source srcset="<?php echo $img_path; ?>service/landi/reason02-dialog2_sp.webp" type="image/webp"
            media="(max-width:1023px)">
        ...
        <picture class="p-service-detail__reason02-dialog-illust sp-hidden">
    ...
    <div class="p-service-detail__reason03-dialog">
      <div class="p-service-detail__reason03-dialog-inner">
        <picture class="p-service-detail__reason03-image">
          <source srcset="<?php echo $img_path; ?>service/landi/reason03-dialog_sp.avif" type="image/avif"
            media="(max-width:1023px)">
          <source srcset="<?php echo $img_path; ?>service/landi/reason03-dialog_sp.webp" type="image/webp"
            media="(max-width:1023px)">
      ...
      <picture class="p-service-detail__reason03-illustration sp-hidden">
      ...
      <div class="p-service-detail__intro-wrap">
        <div class="p-service-detail__intro-hero">
          ...
          <div class="p-service-detail__intro-hero-device">
            ...
            <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--01 sp-hidden">
            ...
            <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--02 sp-hidden">
            ...
            <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--03 close sp-hidden">
            ...
            <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--04 close sp-hidden">
            ...
            <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--05 sp-hidden">
            ...
            <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--06 sp-hidden">
          ...
          <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--01 pc-hidden">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo01.avif" type="image/avif">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo01.webp" type="image/webp">
            <img src="<?php echo $img_path; ?>service/landi/intro-photo01.webp" alt="" width="" height=""
              loading="lazy">
          ...
          <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--02 pc-hidden">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo02.avif" type="image/avif">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo02.webp" type="image/webp">
            <img src="<?php echo $img_path; ?>service/landi/intro-photo02.webp" alt="" width="" height=""
              loading="lazy">
          ...
          <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--03 close pc-hidden">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo03.avif" type="image/avif">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo03.webp" type="image/webp">
            <img src="<?php echo $img_path; ?>service/landi/intro-photo03.webp" alt="" width="" height=""
              loading="lazy">
          ...
          <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--04 close pc-hidden">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo04.avif" type="image/avif">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo04.webp" type="image/webp">
            <img src="<?php echo $img_path; ?>service/landi/intro-photo04.webp" alt="" width="" height=""
              loading="lazy">
          ...
          <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--05 pc-hidden">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo05.avif" type="image/avif">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo05.webp" type="image/webp">
            <img src="<?php echo $img_path; ?>service/landi/intro-photo05.webp" alt="" width="" height=""
              loading="lazy">
          ...
          <picture class="p-service-detail__intro-hero-photo p-service-detail__intro-hero-photo--06 pc-hidden">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo06.avif" type="image/avif">
            <source srcset="<?php echo $img_path; ?>service/landi/intro-photo06.webp" type="image/webp">
            <img src="<?php echo $img_path; ?>service/landi/intro-photo06.webp" alt="" width="" height=""
              loading="lazy">
  ...
  <div class="c-grid-inner">
    <section class="p-service-detail__section p-service-detail__client">
      <h2 class="p-service-detail__section-title large center sp-hidden"><strong class="c-red">
          <strong class="u-txt-red">大手ハウスメーカー16社の100％が導入中</strong><br>
        </strong>500社以上から支持されています。</h2>
      <h2 class="c-ttl__h2 c-sp-section-separate mt-0 pc-hidden u-align-center"><strong class="c-red">
          <strong class="u-txt-red">大手ハウスメーカー16社の<br>100％が導入中</strong>
        </strong>500社以上から<br>支持されています。</h2>
      <div class="p-service-detail__client-rail splide">
        <div class="splide__track">
          <ul class="splide__list">
            <li class="splide__slide"><img src="<?php echo $img_path ?>service/landi/landi-rail_1.webp" alt="" width=""
    ...
    <section class="p-service-detail__section p-service-detail__support">
      <h2 class="p-service-detail__section-title large center sp-hidden">
        なぜ『ランディPRO』が<br><strong class="u-txt-red">支持される</strong>のか
      </h2>
      <h2 class="c-ttl__h2 c-sp-section-separate pc-hidden u-align-center mb-5">なぜ『ランディPRO』が<br><strong
          class="u-txt-red">支持される</strong>のか</h2>
        ...
        <div class="p-service-detail__support-item-inner c-col col2">
          ...
          <div class="p-service-detail__support-item-graph c-col__item">
            <picture class="p-service-detail__support-item-graph-image">
              <source srcset="<?php echo $img_path; ?>service/landi/support-graph01_sp.avif" type="image/avif"
                media="(max-width:1023px)">
              <source srcset="<?php echo $img_path; ?>service/landi/support-graph01_sp.webp" type="image/webp"
                media="(max-width:1023px)">
      ...
      <div class="p-service-detail__support-item">
        ...
        <div class="p-service-detail__support-item-btn sp-hidden">
          <?php get_template_part('/component/btn', null, [
              'url'   => '/service/landi/case',
              'label' => '機能と効果を見る',
            ]);  ?>
  ...
  <section class="p-service-detail__cta js-parallax-wrapper" data-parallax-sp="false">
    <picture class="p-service-detail-cta__image js-parallax-target" aria-hidden="true" data-parallax-start="top bottom">
      <source srcset="<?php echo $img_path; ?>service/landi/cta-background_sp.avif" type="image/avif"
        media="(max-width:1023px)">
      <source srcset="<?php echo $img_path; ?>service/landi/cta-background_sp.webp" type="image/webp"
        media="(max-width:1023px)">
    ...
    <div class="p-service-detail-cta__content">
      <p class="p-service-detail-cta__lead">
        注文建築業界の土地探し<br class="pc-hidden">顧客案件の成約率向上のことなら、
      </p>
  ...
  <div class="c-grid-inner">
    <section class="p-feature-casestudy c-section">
      <div class="c-ttl__wrapper">
        <h2 class="c-ttl__h2 c-sp-section-separate c-sp-section-separate">解決してきた課題<span class="sp-hidden">（事例紹介）</span>
        </h2>
    ...
    <section class="c-section p-service-detail__contact">
      <div class="c-ttl__wrapper">
        <h2 class="c-ttl__h2 c-sp-section-separate c-sp-section-separate">お気軽にお問い合わせください</h2>
      </div>
