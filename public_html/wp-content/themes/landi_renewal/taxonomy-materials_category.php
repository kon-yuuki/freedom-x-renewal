...
<nav class="c-breadNav">
  <ul class="c-breadNav-list">
    ...
    <li class="c-breadNav-item">
      <a href="/materials/" class="c-breadNav-link c-linelink--hidden"><span class="c-linelink__txt">お役立ち資料一覧</span></a>
    </li>
...
<section class="p-company-fv p-materials-fv">
  <div class="l-fv flex">
    <hgroup class="l-fv__heading">
      ...
      <p class="l-fv__heading--main big"><?php echo $current_term_name  ?></p>
    </hgroup>
...
<main class="p-materials c-main non-module c-content">
  <div class="c-grid-outer p-materials-inner">
    <?php
    ...
    <nav class="p-top-casestudy__nav">
      <ul class="p-top-casestudy__cat-list">
        <!-- 「すべて」のリンク - アーカイブページがカレントの場合はis-currentクラスを追加 -->
    ...
    <div class="p-materials-list c-col col3">
      ...
      // WP_Queryを使用してmaterials投稿タイプから該当カテゴリの記事のみを取得
