...
<div id="wrap">
	...
	<article id="landi_area">
			...
			<div class="inner">
				...
				<div class="flex">
					<div class="item">
						...
						<div class="img_box">
							<img loading="lazy" src="<?= get_template_directory_uri(); ?>/src/img/landi_area/sec_10_10.svg" width="172.62" alt="ランディPRO導入店に家族でご来場するイラスト">
						</div>
					</div>
					<div class="item">
						<div class="txt">
		...
		<section id="sec_20">
			<div class="inner">
				<h2 class="head_h2">ランディPRO導入店リスト</h2>
